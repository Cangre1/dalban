      ...
      <div className="contenedor-custom !py-12 lg:!py-28 space-y-16">
        ...
        <div>
          ...
          >
            {/* Primer elemento de la grilla con gradiente */}
            <div
              className="bg-cover bg-center py-32 lg:py-60 relative group shadow-lg hover:shadow-2xl transition-all ease-in-out duration-300 transform hover:-translate-y-1 bg-red-800"
              style={{
                backgroundImage: `linear-gradient(to top, #252969 10%, rgba(0,0,0,0) 50%), url(${insights.grid[0].src})`,
              }}
            >
            ...
            {/* Segundo elemento de la grilla */}
            <div
              className="bg-cover bg-center relative py-32  lg:py-60 shadow-lg hover:shadow-2xl transition-all ease-in-out duration-300 transform hover:-translate-y-1"
              style={{
                backgroundImage: `linear-gradient(to top, #252969 10%, rgba(0,0,0,0) 50%), url(${insights.grid[1].src})`,
              }}
            >
